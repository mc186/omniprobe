...
function(fetch_project)
  ...
  set(SOURCE ${CMAKE_BINARY_DIR}/deps/${FETCH_SOURCE_NAME}/source)
  set(BUILD ${CMAKE_BINARY_DIR}/deps/${FETCH_SOURCE_NAME}/build)
  set(SUBBUILD ${CMAKE_BINARY_DIR}/deps/${FETCH_SOURCE_NAME}/subbuild)
...
#   )
  ...
  set("${FETCH_SOURCE_NAME}_LOCATION" ${CMAKE_BINARY_DIR}/deps/${FETCH_SOURCE_NAME} PARENT_SCOPE)
