...
hipcc -L/home1/klowery/.local/lib -ldh_comms -fpass-plugin=/work1/amd/klowery/instrument-amdgpu-kernels/build/lib/libAMDGCNMemTraceHIP.so -I/home1/klowery/.local/include/dh_comms -fgpu-rdc --offload-arch=gfx90a  -std=c++17 -ggdb -O3  quicktest.cc  -v  -o quicktest 
#hipcc -fpass-plugin=/work1/amd/klowery/instrument-amdgpu-kernels/build/lib/libAMDGCNMemTraceHIP.so -fgpu-rdc --offload-arch=gfx90a  -std=c++17 -ggdb -O3  -c quicktest.cc
