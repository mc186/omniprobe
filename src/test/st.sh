...
hipcc -fpass-plugin=/work1/amd/klowery/instrument-amdgpu-kernels/build/lib/libAMDGCNMemTrace.so -I/opt/rocm/include -I/opt/rocm/include/roctracer  -O3 quicktest.cc -L/opt/rocm/roctracer/lib  -v -o quicktest
